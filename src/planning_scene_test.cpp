...
#include <triple_constraint_planner/kinematics/grasping point.h>
int main(int argc, char **argv)
{
    ...
    std::cout << grp.planning_group << std::endl;
    std::cout << grp.start.transpose() << std::endl;
    robot_state::RobotState &current_state = planning_scene->getCurrentStateNonConst();
    current_state.setJointGroupPositions(grp.planning_group, grp.start);
    ...
    Eigen::Quaterniond quat(grp.grasp3_obj.linear());
    ...
    stefan_pose.position.x = grp.grasp3_obj.translation()[0];
    stefan_pose.position.y = grp.grasp3_obj.translation()[1];
    stefan_pose.position.z = grp.grasp3_obj.translation()[2];
